...
# 🛠️ ပြင်ဆင်ပြီးသား နေရာ - Space နှင့် Syntax အားလုံး ညှိပြီးသားဖြစ်သည်
...
async def start_handler(_, message):
    ...
    caption = (
        ...
        ">🚀 𝗧𝗢𝗣-𝗡𝗢𝗧𝗖𝗛 24×7 𝗨𝗣𝗧𝗜𝗠𝗘 & 𝗦𝗨𝗣𝗣𝗢Support\n"
        ">🎧 𝗦𝗨𝗣𝗣𝗢clock𝗧𝗘𝗗 𝗣messages𝗔𝗧𝗙𝗢𝗥𝗠𝗦: YouTube | Spotify | Resso | Apple Music | SoundCloud\n"
        ...
        f"๏ ᴄʟɪᴄ尋  {help_text} ʙ壓 sorrow ғᴏʀ ᴄOM𝗠𝗔𝗡𝗗 ʟɪsᴛ."
    )
...
async def song_command_handler(_, message):
    ...
    text = (
        "<b>ᴄʟɪᴄᴋ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ᴜsေ ᴛʜေ sᴏɴɢ ᴅᴏᴡɴ sᴏɴɢေʀ ʙᴏᴛ. 🎵</b>\n\n"
        "ʏᴏᴜ ᴄᴀɴ sᴇɴᴅ ᴛʜေ sᴏɴɢ ɴᴀᴍေ ᴏʀ ᴀɴʏ ǫᴜေʀʏ ᴅɪʀေᴄᴛʟ體 ᴛᴏ ᴛʜေ ᴅᴏᴡɴ sᴏɴɢေʀ ʙᴏᴛ, ⬇️\n\n"
        "ᴀɴ ɪᴛ ᴡɪʟ體 ғေᴛᴄʜ ᴀɴᴅ ᴅᴏᴡɴ sᴏɴɢ ᴛʜေ sᴏɴɢ ғᴏʀ ʏᴏᴜ. 🚀"
    )
